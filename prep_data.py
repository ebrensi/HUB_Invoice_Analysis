...
total_event_hours = (event_room_hours.fillna(0.0) +
                     event_setup_hours.fillna(0.0))
...
total_event_income = (event_room_income.fillna(0.0) +
                      event_service_income.fillna(0.0) +
                      event_setup_income.fillna(0.0))
